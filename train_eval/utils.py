...
def handplot(points, outputs_xyz, gt_xyz, images):  # Visualization: show the 0th (in one batch) raw depth image, point cloud combining GT joints, point cloud combining predicted joints
